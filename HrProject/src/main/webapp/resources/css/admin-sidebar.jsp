    ...
    <ul class="menu-list">
        <li class="menu-item ${param.menu == 'personnel' ? 'active' : ''} has-submenu">
            ...
            <ul class="submenu ${param.menu == 'personnel' ? 'open' : ''}">
                <li><a href="<c:url value='/admin/personnel/info' />">인사조회</a></li>
                <li><a href="<c:url value='/admin/personnel/appointment' />">발령조회</a></li>
                <li><a href="<c:url value='/admin/personnel/organization' />">조직도 조회</a></li>
            </ul>
        </li>
