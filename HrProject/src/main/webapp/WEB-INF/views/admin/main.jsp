        ...
        <div class="dashboard-row">
            <div class="dashboard-chart">
                ...
                <div class="chart-container">
                    <div class="chart-bar"><div class="bar-label">인사팀</div><div class="bar-value" style="width:15%;">15</div></div>
                    <div class="chart-bar"><div class="bar-label">개발팀</div><div class="bar-value" style="width:35%;">35</div></div>
                    <div class="chart-bar"><div class="bar-label">영업팀</div><div class="bar-value" style="width:25%;">25</div></div>
                    <div class="chart-bar"><div class="bar-label">마케팅팀</div><div class="bar-value" style="width:20%;">20</div></div>
                    <div class="chart-bar"><div class="bar-label">경영지원팀</div><div class="bar-value" style="width:30%;">30</div></div>
                </div>
            </div>
